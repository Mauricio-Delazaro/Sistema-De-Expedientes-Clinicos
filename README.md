...
- **Bitácoras**
    - [Carpeta de bitácoras](/Bitácoras/)
    - **Generales**
        - [Primera entrega general](/Bitácoras/Generales/primera_entrega_general.md)
        - [Segunda entrega general](/Bitácoras/Generales/segunda_entrega_general.md)
        - [Tercera entrega general](/Bitácoras/Generales/tercera_entrega_general.md)
    - **Semanales**
        - [Primera entrega semanal](/Bitácoras/Semanales/primer_entrega_semanal.md)
        - [Segunda entrega semanal](/Bitácoras/Semanales/segunda_entrega_semanal.md)
        - [Tercera entrega semanal](/Bitácoras/Semanales/tercera_entrega_semanal.md)